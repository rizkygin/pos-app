...
(async () => {
  ...
  const result = await page.evaluate(() => {
    ...
    spacer.textContent = 'x'.repeat(50);
    ...
    return { scrollHeightAfter, clientHeight: main.clientHeight, scrollTopImmediately, rectTopImmediately: rectImmediately.top };
  });
  ...
  await page.screenshot({ path: '/tmp/sticky-scrolled4.png' });
