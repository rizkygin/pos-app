    ...
    return (
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4 *:min-w-0">
            <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-green-100 dark:border-green-900/50">
                ...
                <CardContent>
                    <div className="text-lg sm:text-2xl font-bold wrap-break-word tabular-nums text-green-900 dark:text-green-300">{formatCurrency(dailyIn)}</div>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/20 dark:to-rose-950/20 border-red-100 dark:border-red-900/50">
                ...
                <CardContent>
                    <div className="text-lg sm:text-2xl font-bold wrap-break-word tabular-nums text-red-900 dark:text-red-300">{formatCurrency(dailyOut)}</div>
            ...
            <Card className="lg:col-start-3">
                ...
                <CardContent>
                    <div className="text-lg sm:text-2xl font-bold wrap-break-word tabular-nums">{formatCurrency(monthlyIn)}</div>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-lg sm:text-2xl font-bold wrap-break-word tabular-nums">{formatCurrency(monthlyOut)}</div>
                    <p className="text-xs text-muted-foreground mt-1">{formatMonthYear(selectedDate)}</p>
                </CardContent>
            </Card>
        </div>
