...
const main = async () => {
    const [user] = await db_1.db.select().from(schema_1.usersTable).where((0, drizzle_orm_1.eq)(schema_1.usersTable.id, userId));
    ...
    const updated = await db_1.db
        ...
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.account.userId, userId), (0, drizzle_orm_1.eq)(schema_1.account.providerId, 'credential')))
