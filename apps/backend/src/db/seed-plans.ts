...
// waitlist, reservations) and kitchenDisplay (Layar Dapur, the KDS) start at
// Max — the full-service restaurant tier. Max Lite keeps the counter's printed
// kitchen ticket and buzzer number (pager); it just has no screen for them.
